...
// 'face' or 'vehicle'
const activeModule = ref(props.initialTab === 'vehicle-alarm' ? 'vehicle' : 'face')

watch(() => props.initialTab, (newTab) => {
  if (newTab === 'vehicle-alarm') activeModule.value = 'vehicle'
  else if (newTab === 'face-alarm') activeModule.value = 'face'
})
</script>
  ...
  <div class="unified-alarm-container">
    ...
    <div class="module-content">
      <transition name="fade-slide" mode="out-in">
        ...
        <VehicleAlarmCenter v-else :hideTitle="true" />
      </transition>
    </div>
  </div>
</template>
